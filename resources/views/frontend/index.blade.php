      ...
      <div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          ...
          <nav class="yamm megamenu-horizontal">
            <ul class="nav">
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-shopping-bag" aria-hidden="true"></i>Robotics</a>
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      ...
                      <div class="col-sm-12 col-md-3">
                        <ul class="links list-unstyled">
                         <li><a href="#">Advance Robotics</a></li>
                        </ul>
                      </div>
                      <!-- /.col -->
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-laptop" aria-hidden="true"></i>Internet of Things(IoT)</a> 
                <!-- ================================== MEGAMENU VERTICAL ================================== -->
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-lg-4">
                        <ul>
                          <li><a href="#">Bio-tech kit</a></li>
                          <li><a href="#">Home Automation Kit</a></li>
                          <li><a href="#">Agri-tech kit</a></li>
                        </ul>
                      </div>
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-paw" aria-hidden="true"></i>Programming for kids</a>
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      <div class="col-sm-12 col-md-3">
                        <ul class="links list-unstyled">
                          <li><a href="#">Scratch Programming</a></li>
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-clock-o"></i>App development</a>
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-lg-4">
                        <ul>
                          <li><a href="#">MIT App Inventor</a></li>
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-diamond"></i>Game Development</a>
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      <div class="col-sm-12 col-md-3">
                        <ul class="links list-unstyled">
                          <li><a href="#">Build 10+ Game</a></li>
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-heartbeat"></i>Drone Technology</a>
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-lg-4">
        ...
        <div id="hero">
          <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
            <div class="item" style="background-image: url({{asset('frontend/assets/images/sliders/01.jpg')}});">
              <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
                  <div class="slider-header fadeInDown-1">Best kit for kids</div>
                  <div class="big-text fadeInDown-1"> Robotics & IoT kits </div>
                  <div class="excerpt fadeInDown-2 hidden-xs"> <span>Buy Robotics and IoT kits and get free access to courses.</span> </div>
            ...
            <div class="item" style="background-image: url({{asset('frontend/assets/images/sliders/02.jpg')}});">
              <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
                  <div class="slider-header fadeInDown-1">Learn 21st centry's skill</div>
                  <div class="big-text fadeInDown-1"> Learn <span class="highlight">Coding</span> </div>
                  <div class="excerpt fadeInDown-2 hidden-xs"> <span>Learn coding and create real life projects.</span> </div>
                  <div class="button-holder fadeInDown-3"> <a href="index.php?page=single-product" class="btn-lg btn btn-uppercase btn-primary shop-now-button">Enroll NOw</a> </div>
                </div>
                <!-- /.caption --> 
              </div>
              <!-- /.container-fluid --> 
            ...
            <div class="row">
              ...
              <div class="hidden-md col-sm-4 col-lg-4">
                <div class="info-box">
                  ...
                  <h6 class="text">Shipping on orders over Rs.999</h6>
                </div>
              </div>
              <!-- .col -->
